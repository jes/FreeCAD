...
static void finishFeature(const Gui::Command* cmd, App::DocumentObject *featureDocObject,
                   ...
                   const bool updateDocument = true)
{
    ...
    auto base = dynamic_cast<PartDesign::Feature*>(featureDocObject);
    if (base)
    ...
    if (obj) {
        cmd->copyVisual(featureDocObject, "ShapeAppearance", obj);
        cmd->copyVisual(featureDocObject, "LineColor", obj);
        cmd->copyVisual(featureDocObject, "PointColor", obj);
        cmd->copyVisual(featureDocObject, "Transparency", obj);
        cmd->copyVisual(featureDocObject, "DisplayMode", obj);
    }

    PartDesignGui::setEdit(featureDocObject, activeBody);
